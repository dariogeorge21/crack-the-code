      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-3.5 rounded-lg bg-zinc-900/60 border border-zinc-800/60 space-y-2">
          ...
          <div className="space-y-1.5 pt-1">
            ...
            <div className="flex justify-between">
              <span className="text-zinc-500">Initial Key / Digit:</span>
              <span className="font-bold text-amber-400">
                {(team.first_digit !== null && team.first_digit !== undefined) || team.master_code?.[0]
                  ? `[ ${team.first_digit !== null && team.first_digit !== undefined ? team.first_digit : team.master_code?.[0]} ]`
                  : "—"}
              </span>
            </div>
            <div className="flex justify-between">
